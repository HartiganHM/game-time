...
module.exports = class Game {
  ...
  stack () {
    for (let i = 0; i < CurrentLevel.level1.length; i++) {
      this.blockArr.push(new SquarePiece(CurrentLevel.level1[i].x, CurrentLevel.level1[i].y, CurrentLevel.level1[i].w, CurrentLevel.level1[i].h));
    }
  }
