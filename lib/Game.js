...
module.exports = class Game {
	constructor (canvas, context, width, height, score) {
		...
		this.ball = new Ball((this.paddle.x - 1) + (this.paddle.w /2), this.paddle.y - 10, 10, 0, Math.PI * 2, false);
	...
	gameLoop () {
		...
		this.ball.move(this.canvas).draw(this.context).paddleHit(this.paddle);
