class Ball {
	...
	// paddleSideHit (paddle) {
	// 	if (this.y > paddle.y && this.y < paddle.y + paddle.h && this.x + this.rStart > paddle.x && this.x - this.rStart < paddle.x + paddle.w) {
	// 		this.dx = -this.dx;
	// 	}
	// 	return this;
	// }
	...
	edgeCheck(canvas) {
		...
		if(this.y + this.dy < canvas.height - 550) {
    		this.dy = -this.dy;
		}
